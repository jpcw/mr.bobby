...
.. literalinclude:: ../../mrbobby/rendering.py
   :lines: 133-143


If filename is None or the boolean is False,  filename is immediatly returned, otherwise new filename will be interpreted  over the mrbobby render_filename function.


Register your plugin(s) 
************************

You register your plugin(s) to mrbobby with classic setuptools entrypoints within your setup.py egg file.
    ...
    .. code-block:: python
        ...
        # -*- Entry points: -*-
        [mr.bobby.plugins]
        render_filename=bobbyplugins.pkg.module:NoFooInFilename
        render_filename=bobbyplugins.pkg.module:NoBarInFilename
        render_filename=bobbyplugins.pkg.module:NeitherBarOrFooInFilename
...
If you want to load NoBarInFilename, just invoque mr bobby with -r 15 . If you target a non registered `order` an ErrorAttribute is raised ::
