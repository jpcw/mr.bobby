...
class resolve_dotted_pathTest(unittest.TestCase):
    ...
    def test_return_abs_path(self):
        ...
        abs_path = self.call_FUT('mrbobby.tests:templates')
...
class resolve_dotted_funcTest(unittest.TestCase):
    ...
    def test_return_func(self):
        ...
        func = self.call_FUT('mrbobby.rendering:jinja2_renderer')
...
class parse_templateTest(unittest.TestCase):
    ...
    @mock.patch('mrbobby.configurator.urlretrieve')
    ...
    def fake_zip(self, url, path):
        ...
        try:
            zf.writestr('.mrbobby.ini', '[questions]\n')
    ...
    def fake_zip_base_path(self, url, path):
        ...
        zf = zipfile.ZipFile(path, 'w')
        try:
            zf.writestr('some/dir/.mrbobby.ini', '[questions]\n')
...
class ConfiguratorTest(unittest.TestCase):
    ...
    def test_parse_questions_basic(self):
        c = self.call_FUT('mrbobby.tests:templates/questions1',
                          self.target_dir,
                          {})
    ...
    def test_ask_questions_empty(self):
        args = ['mrbobby.tests:templates/questions1',
                self.target_dir,
                {}]
    ...
    def test_pre_post_render_hooks_multiple(self):
        c = self.call_FUT(
            'mrbobby.tests:templates/render_hooks',
            self.target_dir,
            {},
        )
